<template>
	<div class="bg-bg p-6 rounded-[21px] w-full">
		...
		<div class="flex justify-center items-center gap-4">
			<div class="bg-yellow-1 text-secondary rounded-[18px] p-3 flex gap-1 sm:gap-2 items-end">
				<Icon name="radix-icons:person" class="w-6 h-6 mb-1.5" />
				<div>
					<p class="font-bold text-sm sm:text-base text-fg -my-1.5">5</p>
					<span class="text-[10px] sm:text-xs">Following</span>
				</div>
			</div>
			<div class="bg-yellow-1 text-secondary rounded-[18px] p-3 flex gap-1 sm:gap-2 items-end">
				<Icon name="radix-icons:person" class="w-6 h-6 mb-1.5" />
